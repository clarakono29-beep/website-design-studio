        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s, i) => {
            ...
            return (
              <div
                key={s.title}
                className="card-service p-7 flex flex-col"
                style={{
                  opacity: inView ? 1 : 0,
              ...
              >
                ...
                <div
                  ...
                  style={{ borderTop: "1px solid color-mix(in oklab, var(--navy) 10%, transparent)" }}
                >
                  <a
                    href={whatsappHref(`Hi Nova Rise, I'd like a quote for ${s.title}.`)}
                    target="_blank"
                  ...
                  <a
                    href={`${mailHref}?subject=Rates enquiry — ${encodeURIComponent(s.title)}`}
                    style={{
                      fontFamily: "var(--font-sans)",
                      fontSize: "0.75rem",
                      color: "color-mix(in oklab, var(--navy) 45%, transparent)",
                      fontWeight: 500,
                      textDecoration: "none",
                    }}
                  >
